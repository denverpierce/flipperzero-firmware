...
static const uint8_t furi_hal_subghz_preset_2fsk_dev34_91khz_async_regs[][2] = {
    ...
    {CC1101_MDMCFG3, 0x83}, // Data rate is 4.79794 kBaud
    {CC1101_MDMCFG4, 0x67}, //Rx BW filter is 270.833333 kHz
    {CC1101_DEVIATN, 0x43}, //Deviation 34.912109 kHz
...
static const uint8_t furi_hal_subghz_preset_2fsk_dev47_60khz_async_regs[][2] = {
    ...
    {CC1101_MDMCFG3, 0x83}, // Data rate is 4.79794 kBaud
    {CC1101_MDMCFG4, 0x67}, //Rx BW filter is 270.833333 kHz
    {CC1101_DEVIATN, 0x47}, //Deviation 4.760742 kHz
...
void furi_hal_subghz_load_preset(FuriHalSubGhzPreset preset) {
    if(preset == FuriHalSubGhzPresetOok650Async) {
        ...
        furi_hal_subghz_load_patable(furi_hal_subghz_preset_2fsk_async_patable);
    } else if(preset == FuriHalSubGhzPreset2FSKDev3491Async) {
        furi_hal_subghz_load_registers(furi_hal_subghz_preset_2fsk_dev34_91khz_async_regs);
        furi_hal_subghz_load_patable(furi_hal_subghz_preset_2fsk_async_patable);
    } else if(preset == FuriHalSubGhzPreset2FSKDev4760Async) {
        furi_hal_subghz_load_registers(furi_hal_subghz_preset_2fsk_dev47_60khz_async_regs);
        furi_hal_subghz_load_patable(furi_hal_subghz_preset_2fsk_async_patable);
